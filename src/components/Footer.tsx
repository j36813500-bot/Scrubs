...
export default function Footer() {
  ...
  return (
    <footer className="relative mt-20 overflow-hidden border-t border-white/30">
      <div className="glass">
          ...
          <div className="grid grid-cols-1 gap-10 md:grid-cols-3">
            ...
            <div>
              <button onClick={() => navigate('/')} className="mb-4 flex items-center gap-2">
                <div className="flex h-11 w-11 items-center justify-center rounded-full glass shadow-premium">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="url(#footGrad)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <defs>
                      <linearGradient id="footGrad" x1="0" y1="0" x2="24" y2="24">
              ...
              <p className="text-sm leading-relaxed text-gray-600">
                وجهتك الأولى للزي الطبي الأنيق في مصر. نقدم تصاميم عصرية بأقمشة فاخرة وراحة استثنائية.
              </p>
            ...
            {/* Links */}
            <div>
              <h3 className="mb-4 text-sm font-extrabold text-gray-800">روابط سريعة</h3>
              <ul className="space-y-2.5">
                {links.map((l) => (
                  <li key={l.path}>
                    <button
                      onClick={() => navigate(l.path)}
                      className="text-sm text-gray-600 transition-colors hover:text-blush-600"
                    >
                      {l.label}
                    </button>
                  </li>
            ...
            {/* Contact */}
            <div>
              <h3 className="mb-4 text-sm font-extrabold text-gray-800">تواصل معنا</h3>
              <ul className="space-y-3 text-sm text-gray-600">
                ...
                <li className="flex items-center gap-2">
                  ...
                  <span>info@eskrbek.com</span>
                </li>
                <li className="flex items-center gap-2">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#cba878" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
