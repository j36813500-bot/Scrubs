...
/**
 * Premium authentication gate modal.
 * Shows when a guest tries to add to cart or checkout.
 * Allows login or signup with name + phone + password.
 */
export default function AuthGateModal({
  ...
  return (
    <div
      ...
      style={{ background: 'rgba(20,10,30,0.7)', backdropFilter: 'blur(12px)' }}
      onClick={onClose}
    >
      <div
        className="relative glass-card rounded-3xl max-w-md w-full p-8 animate-scale-in overflow-hidden"
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <button
            onClick={onClose}
            className="absolute top-0 left-0 w-9 h-9 rounded-full glass flex items-center justify-center hover:bg-red-100 transition-colors"
          >
          ...
          <div className="space-y-3">
            ...
            <button onClick={handleSubmit} disabled={loading} className="btn-premium w-full">
